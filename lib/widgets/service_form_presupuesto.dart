...
import '../identificadorEspera.dart';

class ServiceFormPresupuesto extends StatefulWidget {
  final String serviceTitle;

  const ServiceFormPresupuesto({@required this.serviceTitle});

  @override
  _ServiceFormPresupuestoState createState() => _ServiceFormPresupuestoState();
}

class _ServiceFormPresupuestoState extends State<ServiceFormPresupuesto> {
  String _titulo;
  var _fecha;
  String _desc;
  DateTime _dateTime;
    ...
    try {
      ...
      if (globals.imagen == 1) {
        ...
        if (await task.onComplete != null) {
          ...
          double a = globals.a;
          double b = globals.b;
          await Firestore.instance.collection('PedidosPresupuesto').add({
            "Titulo": "$_titulo",
            "Descripcion": "$_desc",
            "Fecha": "$fecha",
            "Hora": "$hora",
          ...
          SharedPreferences pref=await SharedPreferences.getInstance();
          //pref.setString('pedido', randomNumber.toString());
        ...
        child: Column(
          children: <Widget>[
            ...
            MaterialButton(
              ...
              child: Text('Solicitar presupuesto'),
              height: 50,
              minWidth: 300,
              onLongPress: null,
