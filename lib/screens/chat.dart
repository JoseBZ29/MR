...
import 'package:ecommerce/widgets/full_photo.dart';
...
class ChatScreenState extends State<ChatScreen> {
  ...
  final ScrollController listScrollController = ScrollController(initialScrollOffset: 50.0);
  ...
  readLocal() async {
    ...
    //pedido=prefs.getString('pedido');
    if (id.hashCode <= peerId.hashCode) {
      groupChatId = '$id-$peerId';
      prefs.setString('ChatID', groupChatId);
      print('Group id: $groupChatId');
    } else {
