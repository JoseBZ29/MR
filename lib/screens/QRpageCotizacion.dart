...
class QRCotizacionPage extends StatefulWidget {
  QRCotizacionPage({Key key}) : super(key: key);

  @override
  _QRCotizacionPageState createState() => _QRCotizacionPageState();
}

class _QRCotizacionPageState extends State<QRCotizacionPage> {


  validar() async {
    SharedPreferences pref=await SharedPreferences.getInstance();
    String identificador=pref.getString('IdenCot');
    print('entro validar');
    String qr;
    await Firestore.instance.collection('PedidosCotizaciones').document(identificador).get().then((document){
    ...
    if(qr=='pendiente'){
      ...
      print('listo');
        ...
        btnOkOnPress: () async {
          ...
          debugPrint('OnClcik');
          prefs.setBool('servicioEnCursoCOtizacion', true);
