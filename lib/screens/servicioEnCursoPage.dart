        ...
        btnOk: FlatButton(
          ...
          onPressed: () async {
            ...
            await Firestore.instance
                ...
                .updateData({
              "EstadoQRFinalizar": "pendiente",
              "QRFinalizar": "$randomNumber"
            });
            Navigator.pushReplacementNamed(context, 'qrPageFinalizar',
                arguments: QR(randomNumber.toString(), iden2, pedido));
          },
          child: Text(
            'Entendido',
            style: TextStyle(
