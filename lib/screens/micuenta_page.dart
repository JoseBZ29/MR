import 'dart:async';
import 'package:ecommerce/widgets/service_form/picker.dart';
...
class _MiCuentaPageState extends State<MiCuentaPage>{
  ...
  void initState() {
   ...
   _init() async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
      ...
      prefurl = prefs.getString('url') ?? 'https://via.placeholder.com/200x200';
      setState(() {
  ...
  Widget _crearCel(){
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        hintText: 'Teléfono',
        labelText: 'Teléfono', ///ttsmy life be like uhhh ahhh uhhhhh ahhh <3
              ...
              child: CircleAvatar(
                ...
                child: ClipOval(
                  child: SizedBox(
                    ...
                    height: 180.0,
                    child: FadeInImage(
                      placeholder: AssetImage('assets/images/logo_splash.png'), 
