...
class QRPageFinalizar extends StatefulWidget {
  QRPageFinalizar({Key key}) : super(key: key);

  @override
  _QRPageFinalizarState createState() => _QRPageFinalizarState();
}

class _QRPageFinalizarState extends State<QRPageFinalizar> {
  @override
  void initState() {
    super.initState();
  }
  ...
  validar() async {
    ...
    if (qr == 'pendiente') {
      ...
      AwesomeDialog(
          ...
          dismissOnTouchOutside: false,
          desc:
              'El codigo QR se ha validado, se ha finalizado el servicio. Gracias por ocupar nuestros servicios.',
          btnOkOnPress: () async {
            debugPrint('OnClcik');
