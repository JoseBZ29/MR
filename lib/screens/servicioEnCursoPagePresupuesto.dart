...
class ServicioEnCursoPresupuestoPage extends StatefulWidget {
  ServicioEnCursoPresupuestoPage({Key key}) : super(key: key);

  @override
  _ServicioEnCursoPagePresupuestoState createState() => _ServicioEnCursoPagePresupuestoState();
}

class _ServicioEnCursoPagePresupuestoState extends State<ServicioEnCursoPresupuestoPage> {
  modal() {
    AwesomeDialog(
        context: context,
        ...
        btnOk: FlatButton(
          ...
          await Firestore.instance
            ...
            Navigator.pushReplacementNamed(context, 'qrFinalizarPresupuesto',arguments: QR(randomNumber.toString(), iden2, pedido));
          },
              ...
              child: FlatButton(
                  ...
                  onPressed: () async {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              Chat(peerId: peerID.toString(), peerAvatar: '')),
                    );
                  },
                  child: Text(
