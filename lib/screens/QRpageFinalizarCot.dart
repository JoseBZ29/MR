...
class QRPageFinalizarCot extends StatefulWidget {
  QRPageFinalizarCot({Key key}) : super(key: key);

  @override
  _QRPageFinalizarCotState createState() => _QRPageFinalizarCotState();
}

class _QRPageFinalizarCotState extends State<QRPageFinalizarCot> {
  @override
  void initState() {
    super.initState();
  }
