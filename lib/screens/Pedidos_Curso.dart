  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: Firestore.instance
          ...
          .where('Cotizaciones',isEqualTo: 'true')
          .snapshots(),
              ...
              children:
                ...
                return Column(
                  children: <Widget>[
                    FlatButton(
                        onPressed: () async {
                          if (document['Cotizaciones'] == 'false') {
                            AwesomeDialog(
                                context: context,
                            ...
                            if(document['EstadoPago']=='aceptado'){
                              print('aceptado');
                              print(document['QR']);
                              print(document['Identificador']);
                              print(document['Pedido']);
                              try{
                                Navigator.pushNamed(context, 'qrCotizacion', arguments: QR(document['QR'],document['Identificador'],document['Pedido'].toString()));
                              }catch(e){
                                print(e);
                              }
                            }else{
